...
import { Save, Upload, Calendar, Clock, User, FileText } from 'lucide-react';
...
export default function LogHours() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-gray-900">Log Hours</h2>
                <p className="text-gray-500">Record your shadowing or volunteering activity.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-6">
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                type="date"
                                required
                                className="w-full pl-10 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500"
                                value={formData.date}
                ...
                <div>
                    ...
                    <textarea
                        ...
                        placeholder="Root canal, Filling, Cleaning..."
                    />
                </div>
