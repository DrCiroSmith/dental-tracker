...
export default function WelcomeModal() {
    ...
    const steps = [
        {
            ...
            icon: <div className="w-12 h-12 bg-teal-100 dark:bg-teal-900/50 rounded-full flex items-center justify-center text-2xl">🦷</div>
        },
        {
            ...
            icon: <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/50 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400"><CheckCircle2 className="w-6 h-6" /></div>
        },
        {
            ...
            icon: <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/50 rounded-full flex items-center justify-center text-2xl">📂</div>
        }
    ];
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl max-w-md w-full overflow-hidden animate-in fade-in zoom-in duration-300">
                        ...
                        {steps.map((_, i) => (
                            <div
                                ...
                                className={clsx(
                                    ...
                                    i === step ? "bg-teal-600 dark:bg-teal-400" : "bg-gray-200 dark:bg-gray-600"
                                )}
                            />
                        ))}
                    </div>
